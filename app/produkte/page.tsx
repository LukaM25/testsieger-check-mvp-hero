      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-2">
          {placeholderProducts.map((product) => (
            <article
              key={product.slug}
              className="group flex flex-col gap-6 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
            >
              ...
              <div>
                ...
                <ul className="mt-2 flex flex-wrap gap-2">
                  {product.deliverables.map((deliverable) => (
                    <li key={deliverable} className="rounded-full bg-slate-900/5 px-3 py-1 text-xs font-medium text-slate-700">
                      {deliverable}
                    </li>
                  ))}
                </ul>
              ...
              <div className="mt-auto flex flex-wrap gap-3">
                ...
                <button
                  type="button"
                  className="inline-flex items-center justify-center rounded-xl bg-slate-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-black"
                >
                  Platzhalter sichern
                </button>
              </div>
