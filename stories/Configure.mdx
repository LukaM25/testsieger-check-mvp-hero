...
<div className='sb-addon'>
  <div className='sb-addon-text'>
    ...
    <span>Discover all addons<RightArrow /></span>
  </div>
...
<div className="sb-section sb-socials">
    <div className="sb-section-item">
      ...
      <span>Star on GitHub<RightArrow /></span>
    </div>
    <div className="sb-section-item">
      <Image 
        width={33}
      ...
      <div>
        ...
        <span>Join Discord server<RightArrow /></span>
      </div>
    </div>
    <div className="sb-section-item">
      <Image 
      ...
      <div>
        ...
        <span>Watch on YouTube<RightArrow /></span>
      </div>
    </div>
    <div className="sb-section-item">
      <Image 
      ...
      <span>Discover tutorials<RightArrow /></span>
    </div>
</div>
